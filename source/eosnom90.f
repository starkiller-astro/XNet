...
C*****SCREENING                                                         
      ...
      ZL=DEXP(ZLAM)
c     write(15,*) 'EOS'
c     write(15,*) zl,dd,z2es
c     write(15,*) z2aj,es,psra                                           
...
C-----WEAK AND INTERMEDIATE SCREENING FACTOR BY GRABOSKE ET AL.         
      ...
      ZZ=Z1*Z2  
c     write(15,*) z1,z2,zl          
      IF(ZZ.GT.0.0.and.iscrn.ge.1) GOTO 5                                   
      H0=0.0                                                            
      GOTO 30                                                           
    5 Z=ZL*ZZ                                                           
      GSIZ=GSI*ZZ                                                       
...
c     write(15,*) 'h0=hw',z,f                                            
      H0=HW                                                             
      DHDZ=Z*(1.+2.*Z*(dLOG(Z)+1.3364))                                 
      GO TO 20                                                          
   10 H0=HI 
c     write(15,*) 'ho=hi',z,f                                                  
      DHDZ=0.86*HI                                                      
   20 FSR=DHDZ*DZLDR                                                    
      FST=DHDZ*DZLDT                                                    
...
c       Z2=ZP(N2I(2,MU))
c       tstscr=dexp(h0(mu))  
c       write(50,*) inam(n2i(1,mu)),inam(n2i(2,mu)),h0(mu)
c  40 Continue                                              
      RETURN                                                            
