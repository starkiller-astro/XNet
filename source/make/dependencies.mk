...
$(call solver_obj,$(JAC_SRC)): $(call SOBJ,xnet_abundances) $(call SOBJ,xnet_conditions) $(call SOBJ,xnet_controls) $(call SOBJ,xnet_data) $(call SOBJ,xnet_linalg) $(if $(filter MA48 PARDISO,$(MATRIX_SOLVER)),$(call source_obj,$(MPI_SRC))) $(call SOBJ,xnet_timers) $(call SOBJ,xnet_types)
$(call source_obj,$(PROBE_SRC)): $(call SOBJ,xnet_controls) $(call SOBJ,xnet_gpu) $(call SOBJ,xnet_linalg) $(call SOBJ,xnet_types)
