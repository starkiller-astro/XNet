...
!===============================================================================
      ...
      real(8) :: tdelstart,tbegin,tend,tcut,t9cut
...
!  Read the thermdynamic trajectory 
        ...
        Read(8,"(3(12x,1pd14.6))") tbegin,tend,tdelstart
        Do n=1,nhmx
...
! For evolution at temperatures below T9=t9cut, we use only weak reactions
        If(tstop<tend) Then
          iweak=-1   
          tstart=t   
          tstop=tend 
...
!===============================================================================
      ...
      integer :: i,j,k,ig,kstep,kout,kts,knr,ii(14)
...
!    &    kstep,t,t9t,rhot,edot,tdel,(aa(ii)*y(ii)),kout
        Write(52,"(i4,1es15.8,2es10.3,2es10.2,14es9.2,i4)") 
