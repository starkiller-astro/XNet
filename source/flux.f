...
!  Check double counting of reactants for each flux
      If(idiag>=1) Write(50,'(a)') 'Flux Init'
      Do i=1,mflx
        countf=1
        countr=1
        Do j=2,3
...
!  Determine flux origin, ifl_orig, and terminus, ifl_term
        ...
        If(idiag>=1) Write(50,'(11i5,2f6.3)') 
...
!  small fluxes
      ...
      EndWhere
      If(idiag>=3) Then
          Write(50,'(a5,es10.3)') 'Flux',flxmin
          Write(50,'(i5,8a5,i5,2es10.3)') (k,nname(nflx(1:3,k)),' <-> ',
...
!     flx_test(1:ny)=-ydot*tdel ! use only with convc>0
      ...
      Enddo
      If(idiag>=3) Then
          Write(50,"(a,i5,es11.3)") "Flux Check",mflx,tdel
          Write(50,"(a5,4es11.3)") 
